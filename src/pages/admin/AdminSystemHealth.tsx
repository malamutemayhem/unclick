...
import SystemCredentialInventoryPanel from "./SystemCredentialInventoryPanel";
...
export default function AdminSystemHealth() {
  return (
    <div>
      ...
      <div className="mb-6 rounded-xl border border-white/[0.06] bg-[#111111] p-6">
      ...
      <SystemCredentialInventoryPanel />
    </div>
  );
}
