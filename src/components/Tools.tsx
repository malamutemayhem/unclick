...
import { categories, PLATFORM_CONNECTOR_NAMES, PLATFORM_CONNECTOR_SLUGS, QUICK_LINKS } from "./tools/constants";
import { ToolDetailModal } from "./tools/ToolDetailModal";
import { ToolFilters } from "./tools/ToolFilters";
import { ToolGrid } from "./tools/ToolGrid";
import { ToolSearch } from "./tools/ToolSearch";
import { scoreFromSummary, targetMatchesTool, testPassKeyForTool } from "./tools/testPass";
import type { Category, ConnectorStatus, TestPassScore, Tool } from "./tools/types";
import {
...
const tools: Tool[] = [
  ...
  {
    name: "eBay",
    description: "Search eBay listings, retrieve item details, and browse product categories via the eBay Browse API. Returns pricing, condition, seller info, shipping options, and image URLs. Built for agents doing price research, product comparison, and marketplace analysis across the world's largest auction and fixed-price marketplace.",
    endpoint: "/v1/ebay",
    category: "Commerce",
    Icon: ShoppingCart,
    capabilities: [
      "Search listings by keyword with category, price, and condition filters",
      "Retrieve full item details: title, price, seller rating, shipping, and condition",
      "Look up items by legacy numeric item ID or new Browse API item ID",
      "Fetch the complete eBay category tree for any marketplace",
    ],
    examplePrompt: "Ask your AI to search eBay for used graphics cards under $300 and compare the top listings",
  },
  {
    name: "Etsy",
    description: "Search Etsy listings, browse shop inventories, and discover handmade and vintage products via the Etsy Open API v3. Returns titles, pricing, images, tags, shop names, and reviews. Built for agents doing product research, gifting recommendations, and marketplace analysis across Etsy's creative seller community.",
    endpoint: "/v1/etsy",
    category: "Commerce",
    Icon: Store,
    capabilities: [
      "Search active listings by keyword with price, category, and sort filters",
      "Retrieve full listing details including images, tags, and materials",
      "Get shop profiles with ratings, sales count, and policy information",
      "Browse all active listings for a specific Etsy shop",
    ],
    examplePrompt: "Ask your AI to search Etsy for personalised wedding gifts under $50 and list the top results",
  },
  {
    name: "Stripe",
    description: "Manage customers, charges, subscriptions, invoices, products, and prices via the Stripe REST API. Read and write billing data across your Stripe account. Built for agents automating revenue operations, generating financial reports, and building subscription management workflows without opening the Stripe dashboard.",
    endpoint: "/v1/stripe",
    category: "Commerce",
    Icon: Receipt,
    capabilities: [
      "List and create customers, charges, and subscriptions",
      "Query invoices by status, customer, and subscription",
      "Browse product catalog and associated pricing plans",
      "Paginate across large datasets with cursor-based pagination",
    ],
    examplePrompt: "Ask your AI to list all overdue Stripe invoices and summarise the total outstanding balance",
  },
  {
    name: "PayPal",
    description: "Create and retrieve PayPal orders and manage invoices via the PayPal REST API. Supports both live and sandbox environments. Built for agents automating payment flows, generating client invoices, and integrating PayPal checkout into custom order management workflows.",
    endpoint: "/v1/paypal",
    category: "Commerce",
    Icon: Receipt,
    capabilities: [
      "Create PayPal orders with CAPTURE or AUTHORIZE intent",
      "Retrieve order details and payment status by order ID",
      "List, create, and send PayPal invoices to clients",
      "Supports live and sandbox environments for testing",
    ],
    examplePrompt: "Ask your AI to create a PayPal order for a $49 product and return the approval link",
  },
  {
    name: "Square",
    description: "Process payments, manage customers, and browse your Square product catalog via the Square REST API. Read and write across payments, orders, and catalog objects. Built for agents automating retail and restaurant operations, reconciling daily transactions, and managing inventory without the Square dashboard.",
    endpoint: "/v1/square",
    category: "Commerce",
    Icon: Store,
    capabilities: [
      "List and create payments with full transaction details",
      "Browse and search the Square product and service catalog",
      "Retrieve customer records and purchase history",
      "Paginate large datasets with cursor-based pagination",
    ],
    examplePrompt: "Ask your AI to list all Square payments from the past week and calculate total revenue",
  },
  {
    name: "QuickBooks",
    description: "Query customers, invoices, items, and payments from QuickBooks Online via the Intuit Accounting API. Use SQL-style queries to filter and paginate records. Built for agents automating bookkeeping workflows, generating financial snapshots, and syncing QuickBooks data into other business systems.",
    endpoint: "/v1/quickbooks",
    category: "Commerce",
    Icon: Receipt,
    capabilities: [
      "Query customers and filter by active status, name, or custom conditions",
      "List, retrieve, and create invoices with line items and due dates",
      "Browse product and service items from the QuickBooks catalog",
      "Query payments and match against invoices for reconciliation",
    ],
    examplePrompt: "Ask your AI to list all unpaid QuickBooks invoices from the last 90 days and total the outstanding amount",
  },
  {
    name: "Plaid",
    description: "Connect bank accounts and retrieve transactions, balances, and identity data via the Plaid API. Supports sandbox, development, and production environments. Built for agents building personal finance tools, expense trackers, income verification workflows, and financial reporting pipelines.",
    endpoint: "/v1/plaid",
    category: "Commerce",
    Icon: TrendingUp,
    capabilities: [
      "Retrieve account details and balances in real time",
      "Fetch transaction history with date range and account filters",
      "Get identity information for account holders",
      "Create Plaid Link tokens to initiate the bank connection flow",
    ],
    examplePrompt: "Ask your AI to fetch last month's transactions and categorise spending by merchant type",
  },
  {
    name: "WooCommerce",
    description: "Read and write products, orders, and customers on a WooCommerce store via the REST API. Supports listing, searching, and creating records across your store. Built for agents automating e-commerce operations, syncing order data into fulfillment systems, and building custom WooCommerce reporting tools.",
    endpoint: "/v1/woocommerce",
    category: "Commerce",
    Icon: ShoppingCart,
    capabilities: [
      "List and search products by category, status, and keyword",
      "Retrieve, filter, and create orders with full line item detail",
      "Browse customer records and filter by email or role",
      "Paginate large catalogs with per-page and page parameters",
    ],
    examplePrompt: "Ask your AI to list all pending WooCommerce orders from today and summarise what needs to be shipped",
  },
  {
    name: "Amazon",
  ...
  {
    name: "Higgsfield",
    description: "Generate cinematic videos and images from text prompts using Higgsfield AI's Soul Styles. Supports async generation with status polling, style selection, aspect ratio, and seed control for reproducible outputs.",
    endpoint: "/v1/higgsfield",
    category: "Media",
    Icon: Video,
    capabilities: [
      "Generate videos from text prompts with Soul Style cinematic looks",
      "Generate images from text prompts with style and dimension control",
      "List all available Soul Styles for consistent visual branding",
      "Poll generation status and retrieve video or image URLs when complete",
    ],
    examplePrompt: "Ask your AI to generate a cinematic 16:9 video of a sunset over mountains using the Cinematic Soul Style",
  },
  {
    name: "HeyGen",
    description: "Create AI avatar videos with voice cloning and script-driven speech using the HeyGen API. Browse available avatars and voices, generate talking-head videos programmatically, and poll for completion.",
    endpoint: "/v1/heygen",
    category: "Media",
    Icon: Video,
    capabilities: [
      "Create avatar videos where an AI persona speaks a custom script",
      "List all available avatars with preview images",
      "Browse voices by language and gender for natural-sounding delivery",
      "Poll video generation status and retrieve the final video URL",
    ],
    examplePrompt: "Ask your AI to create a product demo video with a HeyGen avatar speaking a sales script",
  },
  {
    name: "Runway",
    description: "Generate videos from text or images using Runway ML's Gen-3 models. Supports both text-to-video and image-to-video modes with configurable duration, aspect ratio, and model selection.",
    endpoint: "/v1/runway",
    category: "Media",
    Icon: Video,
    capabilities: [
      "Generate videos from a text prompt or by animating an input image",
      "Choose between Gen-3 Turbo (fast) and Gen-3 Alpha (quality) models",
      "Configure duration, aspect ratio, and seed for reproducible results",
      "Poll task status and retrieve the completed video URL",
    ],
    examplePrompt: "Ask your AI to animate a product photo into a 5-second video using Runway Gen-3 Turbo",
  },
  {
    name: "Pika",
    description: "Generate creative AI videos from text prompts or images using Pika. Supports style selection, motion intensity, aspect ratio, and async polling for completion.",
    endpoint: "/v1/pika",
    category: "Media",
    Icon: Video,
    capabilities: [
      "Generate videos from text prompts with creative styles and motion control",
      "Animate input images into dynamic video clips",
      "Browse available styles for consistent visual aesthetics",
      "Poll generation status and retrieve the final video URL",
    ],
    examplePrompt: "Ask your AI to generate a 9:16 social media video from a product description using Pika",
  },
  {
    name: "Kling AI",
    description: "Generate high-quality AI videos from text using Kling AI by Kuaishou. Supports standard and professional modes, configurable duration, and optional image-to-video with reference images.",
    endpoint: "/v1/kling",
    category: "Media",
    Icon: Video,
    capabilities: [
      "Generate text-to-video with standard (fast) or professional (quality) modes",
      "Use reference images for image-guided video generation",
      "Configure duration (5s or 10s), aspect ratio, and guidance scale",
      "Poll task status and retrieve the completed video URL",
    ],
    examplePrompt: "Ask your AI to generate a 10-second professional quality video of a futuristic cityscape using Kling AI",
  },

  // ── Marketing / Email ──────────────────────────────────────────────────────
  {
    name: "Mailchimp",
    description: "Manage Mailchimp email marketing campaigns, audiences, and subscribers. List and create campaigns, manage audience lists, add or search for subscribers, and access detailed contact data - all through a simple API.",
    endpoint: "/v1/mailchimp",
    category: "Platform",
    Icon: Mail,
    capabilities: [
      "List and manage audiences (subscriber lists) with stats",
      "Create and retrieve email campaigns",
      "List, add, and search subscribers in any audience",
      "Filter members by subscription status",
    ],
    examplePrompt: "Ask your AI to add a new subscriber to your Mailchimp audience and check recent campaign stats",
  },
  {
    name: "SendGrid",
    description: "Send transactional emails and manage marketing contacts via the SendGrid v3 API. Access dynamic email templates, track send stats, and grow your contact lists - with enterprise-grade deliverability built in.",
    endpoint: "/v1/sendgrid",
    category: "Platform",
    Icon: Mail,
    capabilities: [
      "Send transactional emails with HTML/text or dynamic templates",
      "List, retrieve, and manage dynamic email templates",
      "Add and manage marketing contacts and lists",
      "Query email send statistics by date range",
    ],
    examplePrompt: "Ask your AI to send a welcome email using a SendGrid dynamic template",
  },
  {
    name: "Mapbox",
    description: "Geocode addresses, get turn-by-turn directions, and generate static map images using the Mapbox APIs. Forward and reverse geocoding, multi-stop routing with step-by-step instructions, and tileset management for custom maps.",
    endpoint: "/v1/mapbox",
    category: "Data",
    Icon: MapPin,
    capabilities: [
      "Forward geocode: address or place name to coordinates",
      "Reverse geocode: coordinates to address/place name",
      "Get driving, walking, or cycling directions between waypoints",
      "Generate static map image URLs for any location and zoom level",
      "List tilesets for custom map styles",
    ],
    examplePrompt: "Ask your AI to geocode a list of addresses and get directions between them using Mapbox",
  },
  {
    name: "Algolia",
    description: "Search and browse Algolia indices to find records instantly. Run full-text search with filters and facets, retrieve individual objects by ID, list all indices, and browse entire indexes with cursor-based pagination.",
    endpoint: "/v1/algolia",
    category: "Data",
    Icon: ScanSearch,
    capabilities: [
      "Full-text search across any Algolia index with filters and facets",
      "Retrieve a single record by objectID",
      "List all indices in the application",
      "Browse entire index contents with pagination cursors",
    ],
    examplePrompt: "Ask your AI to search your Algolia product index for 'wireless headphones' under $100",
  },
  {
    name: "Pinecone",
    description: "Interact with Pinecone vector databases for AI-native similarity search. Query indexes for nearest-neighbor vectors, upsert embeddings with metadata, delete vectors, and manage index configurations.",
    endpoint: "/v1/pinecone",
    category: "Storage",
    Icon: Database,
    capabilities: [
      "List and describe vector indexes with dimension and metric info",
      "Query indexes for k-nearest-neighbor vectors",
      "Upsert vectors with IDs and optional metadata",
      "Delete vectors by ID, filter, or namespace",
    ],
    examplePrompt: "Ask your AI to query your Pinecone index for the 10 most similar vectors to a given embedding",
  },
  {
    name: "Mixpanel",
    description: "Access Mixpanel product analytics data for events, funnels, and retention. Track custom events, query event analytics over time, analyze funnel conversion rates, and export raw event data for custom analysis.",
    endpoint: "/v1/mixpanel",
    category: "Data",
    Icon: TrendingUp,
    capabilities: [
      "Track custom events via the Mixpanel ingestion API",
      "Query event analytics with time-series breakdowns",
      "Analyze funnel conversion rates and drop-off points",
      "Get user retention cohort data",
      "Export raw NDJSON event data for custom analysis",
    ],
    examplePrompt: "Ask your AI to pull last week's funnel conversion data from Mixpanel and summarize where users drop off",
  },
  {
    name: "Datadog",
    description: "Monitor infrastructure and application performance via the Datadog API. List and create alert monitors, query metric time-series data, browse dashboards, and review the events stream - all without leaving your workflow.",
    endpoint: "/v1/datadog",
    category: "Platform",
    Icon: Activity,
    capabilities: [
      "List and manage monitors (alerts) with status and tags",
      "Create new metric and service-check monitors",
      "Query metric time-series data with custom expressions",
      "List dashboards and browse the event stream",
    ],
    examplePrompt: "Ask your AI to check for any critical Datadog monitors that are currently alerting",
  },
  {
    name: "DeepL",
    description: "Translate text, documents, and HTML with DeepL's state-of-the-art neural translation engine. Supports 30+ languages, formality control, tag-handling, and document translation for Word, PDF, and PowerPoint files.",
    endpoint: "/v1/deepl",
    category: "Text",
    Icon: Languages,
    capabilities: [
      "Translate text or arrays of texts to 30+ languages",
      "Auto-detect source language or specify explicitly",
      "Control formality level for supported languages",
      "Submit documents (PDF, Word, PowerPoint) for full translation",
      "Check API usage and quota for the billing period",
    ],
    examplePrompt: "Ask your AI to translate a product description into German, French, and Japanese using DeepL",
  },
  {
    name: "AssemblyAI",
    description: "Transcribe audio and video files with AssemblyAI's speech-to-text API. Supports automatic language detection, speaker diarization, AI summarization, sentiment analysis, auto-chapters, and named entity recognition.",
    endpoint: "/v1/assemblyai",
    category: "Media",
    Icon: Headphones,
    capabilities: [
      "Transcribe audio/video files from any public URL",
      "Auto-detect language or specify the source language",
      "Enable speaker labels, auto-chapters, and entity detection",
      "Generate AI summaries in bullets, paragraph, or headline format",
      "Retrieve transcripts split into sentences or paragraphs",
    ],
    examplePrompt: "Ask your AI to transcribe a podcast episode URL with speaker labels and generate a bullet-point summary",
  },
  {
    name: "Groq",
    description: "Run LLM inference at ultra-fast speeds with Groq's LPU hardware. Access Llama 3, Mixtral, Gemma, and other open-weight models via an OpenAI-compatible API - ideal for high-throughput AI pipelines requiring low latency.",
    endpoint: "/v1/groq",
    category: "Platform",
    Icon: Zap,
    capabilities: [
      "Chat completions with Llama 3, Mixtral, Gemma, and more",
      "OpenAI-compatible API format for easy migration",
      "Supports system prompts, temperature, and token limits",
      "List available models with context window sizes",
    ],
  ...
  {
    name: "PagerDuty",
    description: "Manage incidents and on-call schedules in PagerDuty via the REST API. List, create, acknowledge, and resolve incidents, browse services, and see who is currently on-call.",
    endpoint: "/v1/pagerduty",
    category: "Platform",
    Icon: Bell,
    capabilities: [
      "List and filter incidents by status, service, or date",
      "Create incidents programmatically on any service",
      "Acknowledge or resolve incidents in bulk",
      "List services and check current on-call schedules",
    ],
    examplePrompt: "Ask your AI to list all triggered PagerDuty incidents and resolve any older than 2 hours",
  },
  {
    name: "CircleCI",
    description: "Inspect and trigger CircleCI pipelines, workflows, and jobs via the CircleCI v2 API. Monitor build status, browse recent pipelines, and programmatically kick off new builds with custom parameters.",
    endpoint: "/v1/circleci",
    category: "Platform",
    Icon: GitBranch,
    capabilities: [
      "List pipelines for a project, filtered by branch",
      "Browse workflows and individual jobs within a pipeline",
      "Trigger new pipeline runs with custom parameters",
      "Get workflow and job status to monitor CI health",
    ],
    examplePrompt: "Ask your AI to trigger a CircleCI pipeline for the main branch and report back when all workflows pass",
  },
  {
    name: "Segment",
    description: "Send tracking events and user identifications to Segment, and manage sources and destinations via the Segment Public API. Ideal for data pipeline orchestration and event-driven analytics.",
    endpoint: "/v1/segment",
    category: "Data",
    Icon: BarChart,
    capabilities: [
      "Track custom events with arbitrary properties",
      "Identify users and attach traits to their profiles",
      "List all sources and destinations in a workspace",
      "Inspect source configuration and enabled state",
    ],
    examplePrompt: "Ask your AI to track a 'Trial Started' event for a new user and identify them with their plan details",
  },
  {
    name: "Postmark",
    description: "Send transactional emails at scale using the Postmark API. Supports HTML and plain text, templated sends, batch delivery, and detailed message search and delivery statistics.",
    endpoint: "/v1/postmark",
    category: "Platform",
    Icon: Mail,
    capabilities: [
      "Send HTML or plain text emails with full header control",
      "Send batches of up to 500 emails in a single call",
      "Retrieve delivery stats including bounces and open rates",
      "Search sent messages and manage reusable email templates",
    ],
    examplePrompt: "Ask your AI to send a batch of personalized onboarding emails to a list of new users via Postmark",
  },
  {
    name: "Gumroad",
    description: "Access your Gumroad digital product store via the API. List products, browse sales history, and view subscriber details for membership products.",
    endpoint: "/v1/gumroad",
    category: "Commerce",
    Icon: ShoppingBag,
    capabilities: [
      "List all products in your Gumroad account",
      "Browse sales with filters by product, buyer email, or date",
      "Get individual sale details including buyer and revenue data",
      "List subscribers for recurring membership products",
    ],
    examplePrompt: "Ask your AI to list this month's Gumroad sales and calculate total revenue per product",
  },
  {
    name: "Together AI",
    description: "Run inference against 100+ open-source models via the Together AI API. Supports chat completions, text completions, and embeddings using Llama, Mistral, Qwen, and many more.",
    endpoint: "/v1/togetherai",
    category: "Platform",
    Icon: Cpu,
    capabilities: [
      "Chat completions with Llama 3, Mistral, Qwen, and 100+ models",
      "Text completions for non-chat base models",
      "Create embeddings for semantic search and retrieval",
      "Browse all available models and their capabilities",
    ],
    examplePrompt: "Ask your AI to run a Llama-3 chat completion on Together AI to summarise a document",
  },
];
  ...
  return (
    <section id="tools" className="relative mx-auto max-w-7xl px-6 py-8">
      <ToolSearch
        ...
        toolsDisplay={SITE_STATS.TOOLS_DISPLAY}
