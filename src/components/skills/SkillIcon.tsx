...
const CATEGORY_STYLE: Record<string, { tint: string; Icon: LucideIcon }> = {
  ...
  "content": { tint: "#e879f9", Icon: Feather },
  "data": { tint: "#2dd4bf", Icon: Database },
  "debugging": { tint: "#fbbf24", Icon: Bug },
  "developer": { tint: "#60a5fa", Icon: Code2 },
  "documents": { tint: "#f59e0b", Icon: FileText },
  "frontend": { tint: "#f472b6", Icon: Palette },
  "github-pr": { tint: "#c084fc", Icon: GitPullRequest },
  "memory-km": { tint: "#a78bfa", Icon: Brain },
  "productivity": { tint: "#fb923c", Icon: ListChecks },
