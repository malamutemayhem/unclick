...
export interface XPassIndexEntry {
  id: string;
  name: string;
  stage: "live_gate" | "live_dogfood" | "safe_proof" | "scope_gated" | "package_ready" | "boundary" | "planned" | "guidance";
  label: string;
  automation: string;
...
export const dogfoodReport = {
  "generatedAt": "2026-05-28T11:08:51.578Z",
  "lastRunAt": "2026-05-28T11:08:51.578Z",
  "status": "pending",
  ...
  "results": [
    {
      ...
      "checkedAt": "2026-05-28T11:08:51.578Z",
