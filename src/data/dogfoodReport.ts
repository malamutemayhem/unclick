...
export const dogfoodReport = {
  ...
  results: [
    ...
    },
    {
      ...
      name: "SecurityPass",
      status: "passing",
      summary: "SecurityPass safe package proof passed in the scheduled XPass package sweep.",
      evidence: "The public fallback trusts package-level SecurityPass proof only; live security probes remain scope-gated.",
      checkedAt: "2026-05-28T00:00:00.000Z",
      runId: "xpass-package-sweep-fallback",
