...
- Do not weaken TestPass, UXPass, SecurityPass, CompliancePass, WakePass, or dogfood gates just to turn checks green.
...
- 🧪 XPass Assistant: TestPass, UXPass, SecurityPass, CompliancePass, dogfood proof.
