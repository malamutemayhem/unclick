// apps/jobsmith/src/lib/pdfArtifacts.ts
//
// Pure, runtime-agnostic heuristics for cleaning extracted PDF text:
// repeated running headers/footers and page numbers are stripped so the voice
// profile sees letter prose, not layout furniture. No PDF library imported here
// so both the Node and browser extractors can reuse it.
