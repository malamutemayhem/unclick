...
//
// The Boardroom read surface (read_messages -> fishbowl_read) returns three
// lanes: the full `messages` feed, the `mentions` lane (messages addressed to
// the calling agent), and an `agents` roster. A busy room returns tens of
