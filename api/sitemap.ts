...
const STATIC_ROUTES: StaticRoute[] = [
  ...
  { path: "/ai-unclick.md",       changefreq: "weekly",  priority: "0.9" },
  { path: "/ai-unclick.json",     changefreq: "weekly",  priority: "0.9" },
  { path: "/openclaw-mcp.md",     changefreq: "weekly",  priority: "0.8" },
  { path: "/agent-harnesses.md",  changefreq: "weekly",  priority: "0.8" },
  { path: "/memory",              changefreq: "weekly",  priority: "0.8" },
  { path: "/ai-memory.md",        changefreq: "weekly",  priority: "0.8" },
  { path: "/ai-memory.json",      changefreq: "weekly",  priority: "0.8" },
  { path: "/why",                 changefreq: "weekly",  priority: "0.8" },
  { path: "/apps",                changefreq: "weekly",  priority: "0.8" },
  { path: "/crews",               changefreq: "weekly",  priority: "0.7" },
  { path: "/dispatch",            changefreq: "weekly",  priority: "0.7" },
  { path: "/xpass",               changefreq: "weekly",  priority: "0.8" },
  { path: "/passport",            changefreq: "weekly",  priority: "0.7" },
  { path: "/autopilot",           changefreq: "weekly",  priority: "0.7" },
  { path: "/skills",              changefreq: "weekly",  priority: "0.6" },
  { path: "/orchestrator",        changefreq: "weekly",  priority: "0.6" },
  { path: "/jobsmith",            changefreq: "weekly",  priority: "0.6" },
  { path: "/memory/setup",        changefreq: "weekly",  priority: "0.6" },
  { path: "/memory/connect",      changefreq: "weekly",  priority: "0.6" },
  { path: "/memory/setup-guide",  changefreq: "weekly",  priority: "0.6" },
