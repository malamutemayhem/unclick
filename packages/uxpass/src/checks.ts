...
export const CORE_CHECKS: CheckSpec[] = [
  ...
  },
  {
    ...
    severity: "medium",
    title: "First viewport avoids generic AI sameness",
    remediation: "Replace broad AI/productivity claims with a distinctive product metaphor and concrete mechanics that could only belong to this product.",
    evaluate: (ctx) => visualCheck(ctx, "generic_ai_surface"),
  },
  {
    id: "VD-010",
    hat: "visual-designer",
    category: "visual-originality",
    severity: "medium",
    title: "First viewport shows real product mechanics",
    remediation: "Expose named tools, memory, checks, routes, jobs, proof, owners, human approval, or product-specific systems above the fold.",
    evaluate: (ctx) => visualCheck(ctx, "missing_product_mechanics"),
  },
  {
    id: "CL-001",
    hat: "cognitive-load",
