// additional-tools.ts
// The ADDITIONAL_TOOLS catalogue, split out of tool-wiring.ts (Stage 3) so the
// registry file stays small. tool-wiring.ts re-exports ADDITIONAL_TOOLS; the
// build-time generators parse this file for tool definitions.
