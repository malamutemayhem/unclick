...
export const CONNECTOR_SETUP: Record<string, ConnectorSetup> = {
  ...
  airtable: {
    ...
    note:        "Create a PAT with the scopes and base access needed for your tables.",
  },
  algolia: {
    displayName: "Algolia",
    credential:  "API key",
    ...
    note:        "Also pass app_id or set ALGOLIA_APPLICATION_ID from the same dashboard.",
  },
  anthropic: {
  ...
  amber: {
    ...
    note:        "An active Amber account is required to generate API tokens.",
  },
  asana: {
    displayName: "Asana",
    credential:  "personal access token",
    ...
    note:        "Paste the PAT into api_key.",
  },
  bandsintown: {
    ...
    note:        "The app ID is a public identifier passed as the app_id query parameter.",
  },
  brickset: {
