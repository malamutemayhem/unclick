...
export const CONNECTOR_SETUP: Record<string, ConnectorSetup> = {
  ...
  airtable: {
    ...
    arg:         "access_token",
    envVar:      "AIRTABLE_ACCESS_TOKEN",
    setupUrl:    "https://airtable.com/create/tokens",
    note:        "User API keys are deprecated; paste a scoped personal access token.",
  },
  algolia: {
    displayName: "Algolia",
    credential:  "API key",
    ...
    note:        "Pass app_id separately or set ALGOLIA_APPLICATION_ID for local handlers.",
  },
  anthropic: {
  ...
  abuseipdb: {
    ...
    setupUrl:    "https://www.abuseipdb.com/account",
    note:        "Open API Settings in your account to view or generate the key.",
  },
  amber: {
  ...
  bandsintown: {
    ...
    note:        "The public API uses app_id as a caller identifier, not a secret.",
  },
  brickset: {
