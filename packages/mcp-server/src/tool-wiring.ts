...
export const ADDITIONAL_TOOLS = [
  ...
  // ── lego-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        page_size: { type: "number" },
        api_key: { type: "string" },
        rebrickable_api_key: { type: "string", description: "Alias for api_key" },
      },
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        search: { type: "string" },
        color_id: { type: "number", description: "Filter by color ID" },
        api_key: { type: "string" },
      },
      required: ["search"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        game: { type: "string" },
        status: { type: "string" },
        tier: { type: "string", description: "Tournament tier (e.g. s, a, b)" },
        api_key: { type: "string" },
      },
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        search: { type: "string" },
        game: { type: "string", description: "Filter by game" },
        api_key: { type: "string" },
      },
    },
  },
  ...
  // ── domain-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        listing_type: { type: "string", description: "Alias for listingType" },
        listing_types: { type: "string", description: "Override listing types" },
        property_types: { type: "string", description: "Property type filter" },
        minBedrooms: { type: "number" },
        maxBedrooms: { type: "number" },
        min_bedrooms: { type: "number", description: "Alias for minBedrooms" },
        max_bedrooms: { type: "number", description: "Alias for maxBedrooms" },
        minPrice: { type: "number" },
        maxPrice: { type: "number" },
        min_price: { type: "number", description: "Alias for minPrice" },
        max_price: { type: "number", description: "Alias for maxPrice" },
        pageSize: { type: "number" },
        page_size: { type: "number", description: "Alias for pageSize" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        property_id: { type: "number", description: "Alias for listing_id" },
        api_key: { type: "string" },
      },
      required: ["listing_id"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        property_category: { type: "string", description: "Alias for propertyCategory" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        suburb: { type: "string", description: "Alias for q" },
        postcode: { type: "string", description: "Alias for q" },
        api_key: { type: "string" },
      },
      required: ["q"],
    },
  ...
  // ── sendle-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        weight_kg: { type: "number", description: "Weight in kg (alias for weight_value)" },
        volume_l: { type: "number", description: "Volume in litres" },
        sendle_id: { type: "string", description: "Sendle ID for auth" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        description: { type: "string", description: "Parcel description" },
        weight_kg: { type: "number", description: "Parcel weight in kg" },
        customer_reference: { type: "string", description: "Customer reference" },
        metadata: { type: "object", additionalProperties: true, description: "Custom metadata" },
        sendle_id: { type: "string", description: "Sendle ID for auth" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        tracking_id: { type: "string" },
        tracking_ref: { type: "string", description: "Alias for tracking_id" },
        sendle_reference: { type: "string", description: "Alias for tracking_id" },
        sendle_id: { type: "string", description: "Sendle ID for auth" },
        api_key: { type: "string" },
      },
      required: ["tracking_id"],
  ...
  // ── ipaustralia-tool.ts ──────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        status: { type: "string" },
        type: { type: "string" },
        class: { type: "string", description: "Trademark class number." },
        limit: { type: "number" },
        offset: { type: "number" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        keyword: { type: "string", description: "Alias for query." },
        status: { type: "string" },
        type: { type: "string", description: "Patent type filter." },
        limit: { type: "number" },
        offset: { type: "number" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        severity: { type: "string", description: "Alias for cvssV3Severity." },
        resultsPerPage: { type: "number" },
        limit: { type: "number", description: "Alias for resultsPerPage." },
        startIndex: { type: "number" },
        offset: { type: "number", description: "Alias for startIndex." },
        date_from: { type: "string", description: "Start publication date." },
        date_to: { type: "string", description: "End publication date." },
        cpe_name: { type: "string", description: "CPE name filter." },
        has_cert_alerts: { type: "boolean" },
        is_kev: { type: "boolean", description: "Filter to Known Exploited Vulnerabilities." },
        api_key: { type: "string" },
      },
      required: ["keyword"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        resultsPerPage: { type: "number" },
        limit: { type: "number", description: "Alias for resultsPerPage." },
        days: { type: "number", description: "Days to look back (default 7, max 120)." },
        severity: { type: "string", description: "CVSS v3 severity: LOW, MEDIUM, HIGH, CRITICAL." },
        api_key: { type: "string" },
      },
    },
  },
  ...
  // ── haveibeenpwned-tool.ts ───────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        email: { type: "string" },
        account: { type: "string", description: "Alias for email." },
        api_key: { type: "string" },
        domain: { type: "string", description: "Filter breaches by domain" },
        include_unverified: { type: "boolean", description: "Include unverified breaches" },
        truncate: { type: "boolean", description: "Truncate response to data classes only" },
      },
      required: ["email"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        domain: { type: "string" },
        is_spam_list: { type: "boolean", description: "Filter by spam list status" },
      },
    },
  },
  {
  ...
  // ── abuseipdb-tool.ts ────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        max_age_in_days: { type: "number", description: "Alias for maxAgeInDays." },
        verbose: { type: "boolean", description: "Include detailed report data." },
        api_key: { type: "string" },
      },
      required: ["ip"],
    },
  ...
  // ── urlscan-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        tags: { type: "array", items: { type: "string" }, description: "Tags for the scan" },
        api_key: { type: "string" },
      },
      required: ["url"],
    },
  ...
  // ── shodan-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        minify: { type: "boolean", description: "Minify the response" },
        api_key: { type: "string" },
      },
      required: ["query"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ip: { type: "string" },
        history: { type: "boolean", description: "Include historical data" },
        minify: { type: "boolean", description: "Minify the response" },
        api_key: { type: "string" },
      },
      required: ["ip"],
  ...
  // ── vercel-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        project_id: { type: "string", description: "Project ID (alias for projectId)." },
        limit: { type: "number" },
        api_key: { type: "string" },
        app: { type: "string", description: "Filter by app name." },
        state: { type: "string", description: "Filter by deployment state." },
        team_id: { type: "string", description: "Vercel team ID." },
      },
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "string", description: "Deployment ID (alias for deploymentId)." },
        api_key: { type: "string" },
        team_id: { type: "string", description: "Vercel team ID." },
      },
  ...
  // ── toggl-tool.ts ────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        api_key: { type: "string" },
        meta: { type: "boolean", description: "Include metadata in response" },
      },
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        until: { type: "string" },
        api_key: { type: "string" },
        start_date: { type: "string", description: "Alias for since" },
        end_date: { type: "string", description: "Alias for until" },
        group_ids: { description: "Array of group IDs to filter by" },
        project_ids: { description: "Array of project IDs to filter by" },
        client_ids: { description: "Array of client IDs to filter by" },
        include_time_entries: { type: "boolean", description: "Include individual time entries" },
      },
      required: ["workspace_id"],
    },
  },
  ...
  // ── usgs-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        min_magnitude: { type: "number", description: "Alias for minmagnitude." },
        limit: { type: "number" },
  ...
  // ── openaq-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "number" },
        lat: { type: "number", description: "Latitude for coordinate-based search" },
        lon: { type: "number", description: "Longitude for coordinate-based search" },
        radius: { type: "number", description: "Radius in meters around lat/lon" },
      },
    },
  },
  {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        distance: { type: "number", description: "Alias for distance_value" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        kwh: { type: "number", description: "Alias for electricity_value" },
        electricity_unit: { type: "string" },
        country: { type: "string" },
        state: { type: "string", description: "US state code for state-level data" },
        api_key: { type: "string" },
      },
  ...
  // ── toilets-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        radius_meters: { type: "number", description: "Alias for radius." },
        limit: { type: "number" },
        accessible_only: { type: "boolean", description: "Only return wheelchair-accessible toilets." },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        source: { type: "string", description: "Data source for the toilet record." },
      },
      required: ["toilet_id"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        sport: { type: "string" },
        confirmed: { type: "boolean", description: "Confirm large payload download (required)" },
      },
    },
  },
  {
  ...
  // ── notion-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        archived: { type: "boolean", description: "Set archived status (update_page)" },
      },
      required: ["action"],
    },
  },
  ...
  // ── readwise-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        book_id: { type: "number" },
        category: { type: "string", description: "Book category filter" },
        highlights: { type: "array", items: {} },
        text: { type: "string", description: "Highlight text for create_highlight" },
        ...
        note: { type: "string", description: "Note on highlight" },
        highlighted_at: { type: "string", description: "ISO date of highlight" },
      },
      required: ["action"],
    },
  },
  ...
  // ── raindrop-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "number", description: "Alias for raindrop_id" },
        link: { type: "string" },
        url: { type: "string", description: "Alias for link" },
        title: { type: "string" },
        excerpt: { type: "string", description: "Raindrop excerpt/description" },
  ...
  // ── clockify-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        page: { type: "number" },
        page_size: { type: "number" },
        tag_ids: { description: "Array of tag IDs" },
        billable: { type: "boolean" },
        archived: { type: "boolean" },
        name: { type: "string", description: "Filter projects by name" },
        date_range_start: { type: "string", description: "Summary date range start (ISO 8601)" },
        date_range_end: { type: "string", description: "Summary date range end (ISO 8601)" },
        groups: { description: "Summary grouping configuration" },
      },
      required: ["action"],
    },
  },
  ...
  // ── splitwise-tool.ts ────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "number" },
        offset: { type: "number" },
        dated_after: { type: "string", description: "Filter expenses after date (ISO 8601)" },
        dated_before: { type: "string", description: "Filter expenses before date (ISO 8601)" },
        date: { type: "string", description: "Expense date (ISO 8601)" },
  ...
  // ── monica-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        gender_id: { type: "number", description: "Gender ID" },
        birthdate_day: { type: "number" },
        birthdate_month: { type: "number" },
        birthdate_year: { type: "number" },
        is_partial: { type: "boolean", description: "Partial contact (less detail)" },
        body: { type: "string" },
      },
      required: ["action"],
    },
  ...
  // ── feedly-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        newer_than: { type: "number", description: "Timestamp in ms" },
        continuation: { type: "string", description: "Pagination cursor" },
        locale: { type: "string", description: "Locale for feed search" },
        feed_ids: { type: "array", items: { type: "string" }, description: "Feed IDs for mark_as_read" },
        category_ids: { type: "array", items: { type: "string" }, description: "Category IDs for mark_as_read" },
        type: { type: "string", description: "Mark type for mark_as_read" },
        last_read_entry_id: { type: "string", description: "Last read entry ID" },
      },
      required: ["action"],
    },
  },
  ...
  // ── openf1-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        session_name: { type: "string", description: "Alias for session_type" },
        country_name: { type: "string" },
        country: { type: "string", description: "Alias for country_name" },
      },
    },
  },
  {
  ...
  // ── openmeteo-tool.ts ────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        latitude: { type: "number" },
        longitude: { type: "number" },
        city: { type: "string", description: "City name (geocoded to lat/lon)" },
        timezone: { type: "string" },
      },
    },
  },
  ...
  // ── openlibrary-tool.ts ──────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        author: { type: "string", description: "Search by author" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        key: { type: "string", description: "Alias for work_id" },
      },
      required: ["work_id"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        key: { type: "string", description: "Alias for author_id" },
      },
      required: ["author_id"],
    },
  },
  ...
  // ── ticketmaster-tool.ts ─────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        country: { type: "string", description: "Alias for countryCode" },
        classificationName: { type: "string" },
        classification: { type: "string", description: "Alias for classificationName" },
        startDateTime: { type: "string" },
        start_date: { type: "string", description: "Alias for startDateTime" },
        end_date: { type: "string" },
        size: { type: "number" },
        page: { type: "number" },
        sort: { type: "string" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        state: { type: "string", description: "Alias for stateCode" },
        size: { type: "number" },
        page: { type: "number" },
        api_key: { type: "string" },
      },
  ...
  // ── seatgeek-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        datetime_local: { type: "string", description: "Filter by local date/time" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        organizer_id: { type: "string", description: "Alias for organization_id" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        venue_id: { type: "string" },
        id: { type: "string", description: "Alias for venue_id" },
        api_key: { type: "string" },
      },
      required: ["venue_id"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "number", description: "Alias for release_id" },
        api_key: { type: "string" },
      },
      required: ["release_id"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "number", description: "Alias for artist_id" },
        api_key: { type: "string" },
      },
      required: ["artist_id"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "number", description: "Alias for label_id" },
        api_key: { type: "string" },
      },
      required: ["label_id"],
    },
  ...
  // ── bandsintown-tool.ts ──────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        artist: { type: "string" },
        artist_name: { type: "string", description: "Alias for artist" },
        app_id: { type: "string" },
      },
      required: ["artist"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      additionalProperties: false,
      properties: {
        game_type: { type: "string", description: "Filter by game type" },
      },
    },
  },
  ...
  // ── guardian-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        to_date: { type: "string" },
        order_by: { type: "string", description: "Sort order (newest, oldest, relevance)" },
        page_size: { type: "number" },
        page: { type: "number" },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "string", description: "Alias for article_id" },
        api_key: { type: "string" },
      },
      required: ["article_id"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      additionalProperties: false,
      properties: {
        query: { type: "string", description: "Filter sections by name" },
        api_key: { type: "string" },
      },
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        edition: { type: "string", description: "Alias for edition_id" },
        api_key: { type: "string" },
      },
      required: ["edition_id"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        query: { type: "string", description: "Alias for q" },
        from: { type: "string" },
        from_date: { type: "string", description: "Alias for from" },
        to: { type: "string" },
        to_date: { type: "string", description: "Alias for to" },
        language: { type: "string" },
        sortBy: { type: "string" },
        sort_by: { type: "string", description: "Alias for sortBy" },
        sources: { type: "string", description: "Comma-separated source IDs" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        date: { type: "string" },
        base: { type: "string" },
        symbols: { type: "string", description: "Comma-separated currency codes to filter." },
        api_key: { type: "string" },
      },
      required: ["date"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        to: { type: "string" },
        amount: { type: "number" },
        value: { type: "number", description: "Alias for amount." },
        api_key: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        units: { type: "string" },
        fields: { type: "array", items: { type: "string" }, description: "Custom weather data fields to include" },
        api_key: { type: "string" },
      },
      required: ["location"],
    },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        flair_id: { type: "string", description: "Post flair ID" },
        flair_text: { type: "string", description: "Post flair text" },
      },
  ...
  // ── mastodon-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "string" },
        status_id: { type: "string", description: "Status ID for boost/favorite" },
        account_id: { type: "string", description: "Account ID for profile/follow" },
        q: { type: "string" },
        acct: { type: "string" },
        visibility: { type: "string", description: "Post visibility: public, unlisted, private, direct" },
        spoiler_text: { type: "string", description: "Content warning text" },
        sensitive: { type: "boolean", description: "Mark media as sensitive" },
        media_ids: { type: "array", items: { type: "string" }, description: "Media attachment IDs" },
        timeline: { type: "string", description: "Timeline type: home, local, public" },
        max_id: { type: "string", description: "Pagination cursor" },
        limit: { type: "number", description: "Max results" },
        unboost: { type: "boolean", description: "Undo a boost" },
        unfavorite: { type: "boolean", description: "Undo a favorite" },
        unfollow: { type: "boolean", description: "Unfollow an account" },
        resolve: { type: "boolean", description: "Resolve search results" },
        types: { type: "string", description: "Filter notification types" },
      },
      required: ["action"],
    },
  },
  ...
  // ── bluesky-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        actor: { type: "string" },
        limit: { type: "number" },
        langs: { type: "array", items: { type: "string" }, description: "Language codes for the post" },
        feed_type: { type: "string", description: "Feed type: timeline, author, likes" },
        parent_uri: { type: "string", description: "Parent post URI for replies" },
        root_uri: { type: "string", description: "Root post URI for threaded replies" },
        post_uri: { type: "string", description: "Post URI for like/repost actions" },
        type: { type: "string", description: "Search type: posts or users" },
        cursor: { type: "string", description: "Pagination cursor" },
        unfollow: { type: "boolean", description: "Unfollow instead of follow" },
      },
      required: ["action"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        thread_id: { type: "string", description: "Existing thread ID to reply to." },
        content: { type: "string", description: "Message content for thread reply or standalone thread." },
        auto_archive_duration: { type: "number", description: "Auto-archive duration in minutes (60, 1440, 4320, 10080)." },
      },
      required: ["bot_token", "channel_id"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        guild_id: { type: "string" },
        limit: { type: "number" },
        after: { type: "string", description: "Fetch members after this user ID for pagination." },
      },
      required: ["bot_token", "guild_id"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        author_id: { type: "string" },
        channel_id: { type: "string" },
        has: { type: "string", description: "Filter: link, embed, file, video, image, sound, sticker." },
  ...
  // ── slack-tool.ts ────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "number" },
        blocks: { description: "Slack Block Kit blocks array (alternative to text)" },
        username: { type: "string", description: "Bot display name override" },
        oldest: { type: "string", description: "Start of time range for reading messages (Unix ts)" },
        latest: { type: "string", description: "End of time range for reading messages (Unix ts)" },
        sort: { type: "string", description: "Sort order for search: score or timestamp" },
        sort_dir: { type: "string", description: "Sort direction: asc or desc" },
        count: { type: "number", description: "Max results for search (default 20, max 100)" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        bot_token: { type: "string" },
        chat_id: { type: "string", description: "Filter updates by chat ID" },
        offset: { type: "number" },
        limit: { type: "number" },
      },
      required: ["bot_token"],
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        caption: { type: "string" },
        parse_mode: { type: "string", description: "Message parse mode: HTML or Markdown" },
        disable_notification: { type: "boolean", description: "Send silently" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        action: { type: "string" },
        user_id: { type: "number" },
        message_id: { type: "number", description: "Message ID (for pin/unpin/delete)" },
        disable_notification: { type: "boolean", description: "Perform action silently" },
      },
  ...
  // ── amazon-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        search_index: { type: "string", description: "Alias for searchIndex" },
        browseNodeId: { type: "string", description: "Browse node ID to search within" },
        browse_node_id: { type: "string", description: "Alias for browseNodeId" },
        ...
        item_count: { type: "number", description: "Alias for itemCount" },
        item_page: { type: "number", description: "Page number" },
        marketplace: { type: "string", description: "Amazon marketplace (e.g. www.amazon.com)" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        asin: { type: "string" },
        asins: { type: "string", description: "Comma-separated ASINs for batch lookup" },
        marketplace: { type: "string", description: "Amazon marketplace" },
        access_key: { type: "string" },
        secret_key: { type: "string" },
        partner_tag: { type: "string" },
        region: { type: "string" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        browse_node_id: { type: "string", description: "Alias for browseNodeId" },
        browse_node_ids: { type: "string", description: "Comma-separated browse node IDs" },
        marketplace: { type: "string", description: "Amazon marketplace" },
        access_key: { type: "string" },
        secret_key: { type: "string" },
        partner_tag: { type: "string" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        asin: { type: "string" },
        marketplace: { type: "string", description: "Amazon marketplace" },
        variation_count: { type: "number", description: "Number of variations to return" },
        variation_page: { type: "number", description: "Pagination page" },
        access_key: { type: "string" },
        secret_key: { type: "string" },
        partner_tag: { type: "string" },
      },
  ...
  // ── shopify-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        action: { type: "string", description: "list, get, create, or update" },
        id: { type: "number", description: "Product ID for get/update" },
        product: { type: "object", additionalProperties: true, description: "Product object for create/update" },
        limit: { type: "number" },
        ...
        since_id: { type: "number", description: "Restrict results to after this ID" },
        fields: { type: "string", description: "Comma-separated fields to include" },
        api_key: { type: "string" },
        access_token: { type: "string" },
        published_status: { type: "string", description: "Filter by published status: published, unpublished, any" },
        title: { type: "string", description: "Filter products by title" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id: { type: "number", description: "Order ID for get" },
        limit: { type: "number" },
        page_info: { type: "string", description: "Cursor for pagination" },
        status: { type: "string" },
        ...
        since_id: { type: "number", description: "Restrict results to after this ID" },
        created_at_min: { type: "string", description: "Min creation date (ISO)" },
        created_at_max: { type: "string", description: "Max creation date (ISO)" },
        fields: { type: "string", description: "Comma-separated fields to include" },
        api_key: { type: "string" },
        access_token: { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        shop_domain: { type: "string" },
        store: { type: "string", description: "Alias for shop_domain" },
        action: { type: "string", description: "list, get, or search" },
        id: { type: "number", description: "Customer ID for get" },
        ...
        created_at_min: { type: "string", description: "Min creation date (ISO)" },
        created_at_max: { type: "string", description: "Max creation date (ISO)" },
        updated_at_min: { type: "string", description: "Min update date (ISO)" },
        fields: { type: "string", description: "Comma-separated fields to include" },
        email: { type: "string" },
        api_key: { type: "string" },
        access_token: { type: "string" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        shop_domain: { type: "string" },
        store: { type: "string", description: "Alias for shop_domain" },
        type: { type: "string", description: "smart, custom, or all" },
        limit: { type: "number" },
        since_id: { type: "number", description: "Restrict results to after this ID" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fulfillment: { type: "object", additionalProperties: true, description: "Fulfillment object for action='create'" },
        limit: { type: "number" },
        since_id: { type: "number", description: "Restrict results to after this ID" },
        fields: { type: "string", description: "Comma-separated fields to include" },
        api_key: { type: "string" },
  ...
  // ── yelp-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        limit: { type: "number" },
        api_key: { type: "string" },
        price: { type: "string", description: "Price filter (1, 2, 3, 4)" },
        radius: { type: "number", description: "Search radius in meters" },
        sort_by: { type: "string", description: "Sort by: best_match, rating, review_count, distance" },
        offset: { type: "number" },
  ...
  // ── xero-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      additionalProperties: false,
      properties: {
        action: { type: "string", description: "list, get, or create" },
        invoice_id: { type: "string", description: "Required for action='get'" },
        body: { type: "object", additionalProperties: true, description: "Invoice object for action='create'" },
        ...
        contact_ids: { type: "string", description: "Comma-separated contact IDs" },
        ids: { type: "string", description: "Comma-separated invoice IDs" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        action: { type: "string", description: "list, get, or create" },
        contact_id: { type: "string", description: "Required for action='get'" },
        body: { type: "object", additionalProperties: true, description: "Contact object for action='create'" },
        search: { type: "string" },
        search_term: { type: "string", description: "Alias for search" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        action: { type: "string", description: "list or create" },
        body: { type: "object", additionalProperties: true, description: "Payment object for action='create'" },
        status: { type: "string" },
        where: { type: "string", description: "Xero where clause" },
        order: { type: "string", description: "Sort order" },
        page: { type: "number" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        report_id: { type: "string", description: "Alias for report_type" },
        from_date: { type: "string" },
        to_date: { type: "string" },
        date: { type: "string", description: "Report date" },
        periods: { type: "number", description: "Number of periods" },
        timeframe: { type: "string", description: "Period timeframe" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        action: { type: "string", description: "list, get, or create" },
        quote_id: { type: "string", description: "Required for action='get'" },
        body: { type: "object", additionalProperties: true, description: "Quote object for action='create'" },
        status: { type: "string" },
        contact_id: { type: "string" },
        date_from: { type: "string" },
        date_to: { type: "string" },
  ...
  // ── ebay-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fieldgroups:   { type: "string", description: "Field groups to include (e.g. MATCHING_ITEMS, FULL)" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        fieldgroups:          { type: "string", description: "Field groups to include" },
        marketplace:          { type: "string" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        description:    { type: "string" },
        created:        { type: "number", description: "Filter charges created after this Unix timestamp." },
      },
      required: ["secret_key"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        send_to_invoicer: { type: "boolean", description: "Whether sender receives a copy" },
      },
      required: ["client_id", "client_secret"],
    },
  },
  ...
  // ── github-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        page:         { type: "number", description: "Page number." },
        sort:         { type: "string", description: "Sort field (e.g. stars, forks, updated)." },
        order:        { type: "string", description: "Sort order: asc or desc." },
        assignees:    { type: "array", items: { type: "string" }, description: "Assignee logins (for create_issue)." },
        milestone:    { type: "number", description: "Milestone number (for create_issue)." },
      },
      required: ["action"],
    },
  },
  ...
  // ── gitlab-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        per_page:     { type: "number", description: "Results per page." },
        page:         { type: "number", description: "Page number." },
        order_by:     { type: "string", description: "Sort field (e.g. last_activity_at, name, created_at)." },
        visibility:   { type: "string", description: "Filter by visibility: public, internal, private." },
      },
      required: ["action"],
    },
  },
  ...
  // ── clickup-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        include_closed: { type: "boolean", description: "Include closed tasks in listing." },
        assignees: { type: "string", description: "Comma-separated assignee IDs for filtering tasks." },
        statuses: { type: "string", description: "Comma-separated status names for filtering tasks." },
        tags: { type: "array", items: { type: "string" }, description: "Tags for task creation." },
      },
  ...
  // ── airtable-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        sort:         { type: "array", items: { type: "object" }, description: "Sort configuration array (for list_records)." },
      },
  ...
  // ── trello-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        id_labels: { type: "string", description: "Comma-separated label IDs (for create_card)." },
      },
  ...
  // ── pushover-tool.ts ──────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        callback: { type: "string", description: "Emergency only: callback URL" },
        monospace: { type: "boolean", description: "Display message in monospace font" },
        timestamp: { type: "number", description: "Unix timestamp to display instead of delivery time" },
      },
  ...
  // ── pika-tool.ts ──────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        seed: { type: "number", description: "Random seed for reproducibility" },
        guidance_scale: { type: "number", description: "Guidance scale for generation quality" },
      },
      required: ["api_key", "prompt"],
    },
  },
  ...
  // ── algolia-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        facets: { type: "array", items: { type: "string" }, description: "Facet attributes to retrieve counts for." },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        options: { type: "object", additionalProperties: true, description: "Monitor options (thresholds, notify_no_data, etc.)." },
      },
  ...
  // ── assemblyai-tool.ts ────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        dual_channel: { type: "boolean", description: "Enable dual channel (stereo) transcription" },
        summary_model: { type: "string", description: "Model to use for summarization" },
      },
  ...
  // ── kling-tool.ts ─────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        camera_control: { type: "object", description: "Optional camera movement control object" },
      },
      required: ["api_key", "prompt"],
    },
  },
  ...
  // ── segment-tool.ts ───────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        context: { type: "object", additionalProperties: true, description: "Segment context object" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        webhook: { type: "string" },
        stream: { type: "boolean" },
        webhook_events_filter: { description: "Array of webhook event types to filter" },
      },
  ...
  // ── openai-tool.ts ────────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        seed: { type: "number" },
        stop: { description: "String or array of strings where the model should stop generating" },
  ...
  // ── anthropic-tool.ts ─────────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        metadata: { type: "object", description: "Request metadata object" },
      },
      required: ["api_key"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        args: { type: "array", description: "Positional query parameters" },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        services: { type: "array", items: { type: "object" }, description: "Service configuration (ports, protocols, handlers)." },
      },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        encoding_format: { type: "string", description: "Output format: float or base64 (default: float)" },
      },
      required: ["input"],
    },
  },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        p: { type: "number", description: "Top-p nucleus sampling" },
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        truncate: { type: "string", enum: ["NONE", "START", "END"], description: "Truncation strategy (default: END)" },
      },
      required: ["texts"],
    },
  },
  ...
  // ── convertkit-tool.ts ───────────────────────────────────────────────────────
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        updated_from: { type: "string", description: "Filter by updated date start (ISO 8601)" },
        updated_to: { type: "string", description: "Filter by updated date end (ISO 8601)" },
      },
      required: ["api_secret"],
    },
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        email: { type: "string" },
        first_name: { type: "string" },
        fields: { type: "object", description: "Custom field key-value pairs" },
      },
