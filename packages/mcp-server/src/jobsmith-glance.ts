// packages/mcp-server/src/jobsmith-glance.ts
//
// Lockstep copy of apps/jobsmith/src/lib/firstGlance.ts for the MCP
// connector (this package cannot import from the app workspace). Keep the
