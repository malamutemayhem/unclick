...
const NAME_OF = {
  ...
  trie: "Trie", skiplist: "Skip List", manacher: "Manacher Palindrome", countingsort: "Counting Sort",
  radixsort: "Radix Sort", treap: "Treap", lis: "LIS Solver", kosaraju: "Kosaraju SCC",
  bucketsort: "Bucket Sort", edmondskarp: "Edmonds-Karp", avltree: "AVL Tree", bipartite: "Bipartite Check",
  eulerpath: "Euler Path", sparsetable: "Sparse Table", millerrabin: "Miller-Rabin", rbtree: "Red-Black Tree",
  heapsort: "Heap Sort", crt: "Chinese Remainder Theorem", graphcolor: "Graph Coloring", extgcd: "Extended GCD",
  eulertotient: "Euler Totient", hopcroftcarp: "Hopcroft-Karp", intervalmerge: "Interval Merge", ternarysearch: "Ternary Search",
  shellsort: "Shell Sort", matexp: "Matrix Exponentiation", segmentintersect: "Segment Intersection", minvertexcover: "Min Vertex Cover",
  suffixauto: "Suffix Automaton", gabow: "Gabow SCC", babygiant: "Baby-step Giant-step", centroid: "Centroid Decomposition",
  ...
  contfrac: "Continued Fractions", lcprefix: "Longest Common Prefix", lehmer: "Lehmer Code", digitdp: "Digit DP",
  coinchange: "Coin Change", editdist: "Edit Distance", powerset: "Power Set", necklace: "Necklace Count",
  derangement: "Derangement", kmpautomaton: "KMP Automaton", rmqsparse: "RMQ Sparse Table", partition: "Integer Partition",
  stirling: "Stirling Numbers", waveletfn: "Haar Wavelet", convexhull3d: "3D Convex Hull", bezierclip: "Bezier Clip",
};
...
const BLURB_OF = {
  ...
  trie: "Prefix tree for word search, prefix counting, and autocomplete.",
  skiplist: "Probabilistic sorted data structure with O(log n) search.",
  manacher: "Find longest palindromic substring in linear time.",
  countingsort: "Integer sorting in O(n+k) time with frequency analysis.",
  radixsort: "Non-comparative integer sort using digit-by-digit bucketing.",
  treap: "Randomized BST combining tree and heap properties.",
  lis: "Find longest increasing subsequence in O(n log n) time.",
  kosaraju: "Find strongly connected components via Kosaraju's two-pass algorithm.",
  bucketsort: "Distribution-based sort dividing elements into buckets then merging.",
  edmondskarp: "Compute maximum flow and minimum cut via BFS-augmenting paths.",
  avltree: "Self-balancing BST with O(log n) insert, search, and height guarantees.",
  bipartite: "Check if a graph is bipartite and return the vertex partition or odd cycle.",
  eulerpath: "Check whether a graph has an Eulerian path or circuit via degree analysis.",
  sparsetable: "Build a sparse table for O(1) range minimum or maximum queries.",
  millerrabin: "Deterministic Miller-Rabin primality test with multiple witnesses.",
  rbtree: "Red-black tree simulation with insert, inorder traversal, and validity check.",
  heapsort: "In-place O(n log n) sorting using a binary heap with swap tracking.",
  crt: "Solve simultaneous congruences using the Chinese Remainder Theorem.",
  graphcolor: "Greedy vertex coloring of an undirected graph with color groups.",
  extgcd: "Extended Euclidean algorithm returning GCD, Bezout coefficients, and modular inverse.",
  eulertotient: "Compute Euler's totient phi(n) counting integers coprime to n.",
  hopcroftcarp: "Maximum bipartite matching via Hopcroft-Karp in O(E * sqrt(V)).",
  intervalmerge: "Merge overlapping intervals and report gaps and total coverage.",
  ternarysearch: "Ternary search on sorted arrays or unimodal extremum finding.",
  shellsort: "Shell sort with gap sequence tracking, comparison and swap counts.",
  matexp: "Matrix exponentiation via fast binary method with optional modular arithmetic.",
  segmentintersect: "Find pairwise intersections among 2D line segments.",
  minvertexcover: "Exact minimum vertex cover via bitmask enumeration (up to 20 vertices).",
  suffixauto: "Suffix automaton construction with distinct substring counting.",
  gabow: "Strongly connected components via Gabow's path-based algorithm.",
  babygiant: "Discrete logarithm solver using baby-step giant-step method.",
  centroid: "Centroid decomposition of trees for efficient path queries.",
  wavelet: "Wavelet tree for range kth-smallest queries on integer arrays.",
  dinic: "Maximum flow computation using Dinic's blocking flow algorithm.",
  lca: "Lowest common ancestor with binary lifting and tree distance queries.",
  maxindepset: "Exact maximum independent set via bitmask enumeration (up to 20 vertices).",
  twosat: "2-SAT boolean satisfiability solver using implication graph and SCC.",
  hld: "Heavy-light decomposition of trees for efficient path queries.",
  mincostflow: "Minimum cost maximum flow using successive shortest paths.",
  persistarray: "Persistent array with version-controlled get/set operations.",
  suffixtree: "Suffix tree construction via Ukkonen's algorithm with substring analysis.",
  ...
  contfrac: "Convert rational numbers to continued fraction representation with convergents.",
  lcprefix: "Find the longest common prefix among an array of strings.",
  lehmer: "Convert between permutations and Lehmer codes for ranking and unranking.",
  digitdp: "Count integers up to N with a given digit sum using digit DP.",
  coinchange: "Minimum coins and combination count for a target amount using DP.",
  editdist: "Full edit distance with backtrace of insert, delete, and replace operations.",
  powerset: "Generate all subsets of a set using bitmask enumeration.",
  necklace: "Count distinct necklaces and bracelets using Burnside's lemma.",
  derangement: "Count and enumerate derangements (permutations with no fixed points).",
  kmpautomaton: "Build a full KMP DFA transition table for streaming pattern matching.",
  rmqsparse: "Build a sparse table for O(1) range minimum/maximum queries.",
  partition: "Count integer partitions with optional part size and count constraints.",
  stirling: "Compute Stirling numbers of the first or second kind via dynamic programming.",
  waveletfn: "Haar wavelet transform (forward and inverse) on power-of-2 length arrays.",
  convexhull3d: "Compute the 3D convex hull of a point set returning triangular faces.",
  bezierclip: "Extract a Bezier sub-curve for a parameter range using de Casteljau subdivision.",
};
...
const DOMAIN_OF = {
  ...
  abn: "abr.business.gov.au", abuseipdb: "abuseipdb.com", alphavantage: "alphavantage.co",
  amber: "amber.com.au", assemblyai: "assemblyai.com", australiapost: "auspost.com.au",
  bandsintown: "bandsintown.com", bgg: "boardgamegeek.com", bungie: "bungie.net",
  carboninterface: "carboninterface.com", chessdotcom: "chess.com", domain: "domain.com.au",
  ebird: "ebird.org", espn: "espn.com", exchangerate: "exchangerate-api.com",
  fpl: "premierleague.com", gdelt: "gdeltproject.org", haveibeenpwned: "haveibeenpwned.com",
  higgsfield: "higgsfield.ai", hunter: "hunter.io", ipapi: "ip-api.com",
  ipaustralia: "ipaustralia.gov.au", kling: "klingai.com", meal: "themealdb.com",
  musicbrainz: "musicbrainz.org", newsapi: "newsapi.org", nvd: "nvd.nist.gov",
  omdb: "omdbapi.com", openexchangerates: "openexchangerates.org",
  openfoodfacts: "world.openfoodfacts.org", openlibrary: "openlibrary.org",
  openaq: "openaq.org", openf1: "openf1.org", pandascore: "pandascore.co",
  pika: "pika.art", podcastindex: "podcastindex.org", radiobrowser: "radio-browser.info",
  rawg: "rawg.io", restcountries: "restcountries.com", seatgeek: "seatgeek.com",
  sendle: "sendle.com", setlistfm: "setlist.fm", sleeper: "sleeper.com",
  speedrun: "speedrun.com", stability: "stability.ai", supercell: "supercell.com",
  tab: "tab.com.au", thelott: "thelott.com", togetherai: "together.ai",
  toilets: "toiletmap.gov.au", trove: "trove.nla.gov.au", untappd: "untappd.com",
  urlscan: "urlscan.io", usgs: "usgs.gov", vault: "vaultproject.io",
  willyweather: "willyweather.com.au",
  csuite: "local", crews: "local", jobsmith: "local", keychain: "local",
  calculator: "local", color: "local", datetime: "local", diceware: "local",
  email: "local", numbers: "local", random: "local", text: "local",
  trivia: "local", "unit-converter": "local",
  commonsensepass: "local", compliancepass: "local", copypass: "local",
  fidelitycopy: "local", flowpass: "local", geopass: "local", igniteonly: "local",
  legalpass: "local", nudgeonly: "local", pushonly: "local", qc: "local",
  securitypass: "local", seopass: "local", sloppass: "local", testpass: "local",
  uxpass: "local", "xpass-aggregated-verdict": "local",
  ...
  trie: "local", skiplist: "local", manacher: "local", countingsort: "local",
  radixsort: "local", treap: "local", lis: "local", kosaraju: "local",
  bucketsort: "local", edmondskarp: "local", avltree: "local", bipartite: "local",
  eulerpath: "local", sparsetable: "local", millerrabin: "local", rbtree: "local",
  heapsort: "local", crt: "local", graphcolor: "local", extgcd: "local",
  eulertotient: "local", hopcroftcarp: "local", intervalmerge: "local", ternarysearch: "local",
  shellsort: "local", matexp: "local", segmentintersect: "local", minvertexcover: "local",
  suffixauto: "local", gabow: "local", babygiant: "local", centroid: "local",
  ...
  contfrac: "local", lcprefix: "local", lehmer: "local", digitdp: "local",
  coinchange: "local", editdist: "local", powerset: "local", necklace: "local",
  derangement: "local", kmpautomaton: "local", rmqsparse: "local", partition: "local",
  stirling: "local", waveletfn: "local", convexhull3d: "local", bezierclip: "local",
};
